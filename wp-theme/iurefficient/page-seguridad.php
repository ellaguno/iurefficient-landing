        ...
        <div class="container">
            ...
            <div class="tip-box security" data-aos="fade-up">
                ...
                <div>
                    ...
                    <p><strong>Iurefficient</strong> esta disenado desde su arquitectura para proteger la informacion confidencial de profesionales y sus clientes. A diferencia de servicios de IA genericos, tu informacion <strong>nunca sale de tu control</strong>.</p>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="technical-grid">
                <div class="technical-block" data-aos="fade-up" data-aos-delay="0">
                    ...
                    <ul>
                        ...
                        <li><strong>Tokens y credenciales:</strong> Contrasenas hasheadas con bcrypt, JWT con expiracion corta</li>
            ...
            <div class="tip-box info" data-aos="fade-up" style="max-width: 800px; margin: var(--spacing-2xl) auto 0;">
                ...
                <div>
                    ...
                    <p>Puedes acceder al registro de auditoria completo desde <strong>Configuracion &rarr; Registros de Auditoria</strong>. Alli veras todas las acciones realizadas en el sistema con marcas de tiempo precisas.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="tip-box security" data-aos="fade-up" style="max-width: 800px; margin: var(--spacing-2xl) auto 0;">
                ...
                <div>
                    ...
                    <p>El diseno de Iurefficient respeta el secreto profesional abogado-cliente. La arquitectura tecnica garantiza que incluso los administradores del sistema no pueden acceder al contenido de los documentos sin autorizacion explicita y registrada.</p>
                </div>
            </div>
            ...
            <div style="max-width: 800px; margin: var(--spacing-2xl) auto 0;" data-aos="fade-up">
                ...
                <ul style="display: flex; flex-direction: column; gap: var(--spacing-sm); color: var(--gray-600);">
                    ...
                    <li style="display: flex; align-items: center; gap: var(--spacing-sm);"><span style="color: var(--primary-500);">&#128273;</span> Proteccion opcional con contrasena</li>
        ...
        <div class="container">
            ...
            <div class="ai-providers-grid" data-aos="fade-up">
                <div class="ai-provider-card">
                    ...
                    <a href="https://openai.com/enterprise-privacy" target="_blank" rel="noopener noreferrer">Ver politica de privacidad empresarial &rarr;</a>
                </div>

                <div class="ai-provider-card">
                    <h4><span style="color: #10b981;">&#128994;</span> Anthropic (Claude API)</h4>
                    <p>"We do not train our models on customer API data"</p>
                    <a href="https://www.anthropic.com/policies/privacy-policy" target="_blank" rel="noopener noreferrer">Ver politica de privacidad &rarr;</a>
                </div>
                ...
                <div class="ai-provider-card">
                    ...
                    <a href="https://openrouter.ai/privacy" target="_blank" rel="noopener noreferrer">Ver politica &rarr;</a>
                </div>
        ...
        <div class="container">
            ...
            <div class="compliance-grid">
                ...
                <div class="compliance-badge" data-aos="fade-up" data-aos-delay="200">
                    <div class="badge-icon">&#127963;&#65039;</div>
                    <h4>Secreto Profesional</h4>
                    <p>Disenado para cumplir con etica legal</p>
                </div>
            </div>

            <div style="max-width: 800px; margin: var(--spacing-2xl) auto 0;" data-aos="fade-up">
                <h3 style="font-size: 1.25rem; font-weight: 700; color: var(--gray-900); margin-bottom: var(--spacing-lg);">Secreto Profesional</h3>
                <p style="color: var(--gray-600); margin-bottom: var(--spacing-md);">Iurefficient esta disenado para respetar las obligaciones de secreto profesional de abogados, contadores y otros profesionales:</p>
                <ul style="display: flex; flex-direction: column; gap: var(--spacing-sm); color: var(--gray-600);">
        ...
        <div class="container">
            ...
            <div class="tip-box info" data-aos="fade-up" style="max-width: 800px; margin: var(--spacing-2xl) auto 0;">
                ...
                <div>
                    ...
                    <p>Contacta al administrador de tu organizacion o envia una solicitud a traves de la seccion de <strong>Perfil &rarr; Privacidad</strong>. Responderemos en un plazo maximo de 20 dias habiles.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="faq-list" data-aos="fade-up">
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>El sistema esta disenado para minimizar este riesgo. La IA solo responde basandose en los documentos de tu caso, no en conocimiento general. Ademas, cada respuesta incluye citas verificables y un indicador de confianza. Si no hay informacion suficiente, el sistema lo indica claramente.</p>
                    </div>
                </details>
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>No. Tus documentos completos nunca salen de tu infraestructura. Solo se envian a las APIs de IA fragmentos pequenos y descontextualizados cuando haces una consulta. Estos fragmentos no contienen identificadores de clientes ni informacion que permita relacionarlos con un caso especifico.</p>
                    </div>
                </details>
    ...
    <section class="contact-security">
        <div class="container">
            <div class="contact-security-card" data-aos="fade-up">
                <h3><span>&#9993;&#65039;</span> Tienes mas preguntas?</h3>
                ...
                <div class="contact-buttons">
                    ...
                    <a href="<?php echo esc_url(home_url('/privacidad/')); ?>" class="secondary">

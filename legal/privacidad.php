...
$base_path = '../';
$current_page = 'legal';
$page_title = 'Aviso de Privacidad - Iurefficient';
$page_description = 'Aviso de Privacidad de Iurefficient. Conoce cómo recopilamos, usamos y protegemos tu información personal.';
$extra_css = [];
$extra_scripts = [];
$page_styles = <<<'CSS'
        .legal-page {
        ...
        <div class="container">
            <div class="legal-content">
                ...
                <div class="highlight-box">
                    <p><strong>Resumen:</strong> Recopilamos información necesaria para proporcionar nuestros servicios. No vendemos tus datos. Tus documentos son confidenciales y están cifrados. Puedes ejercer tus derechos ARCO en cualquier momento.</p>
                </div>

                <h2 id="responsable">1. Identidad del Responsable</h2>
                <p>
                    <strong>Iurefficient</strong>, con domicilio en [Dirección completa], Ciudad de México, México, es responsable del tratamiento de sus datos personales conforme a lo establecido en la Ley Federal de Protección de Datos Personales en Posesión de los Particulares (LFPDPPP) y su Reglamento.
                </p>
                ...
                <ul>
                    ...
                    <li>Nombre del despacho u organización</li>
                    <li>Cargo o puesto</li>
                </ul>

                <h3>2.2 Datos de Facturación</h3>
                <ul>
                    <li>RFC</li>
                    <li>Domicilio fiscal</li>
                    <li>Datos bancarios o de tarjeta de crédito (procesados por terceros certificados PCI-DSS)</li>
                </ul>
                ...
                <p>Los documentos, casos y demás información que usted cargue a la plataforma son tratados como información confidencial bajo estrictas medidas de seguridad. Este contenido es de su exclusiva propiedad y no es utilizado para fines distintos a proporcionarle el servicio.</p>
                ...
                <ul>
                    ...
                    <li>Procesar y gestionar su suscripción</li>
                ...
                <ul>
                    <li>Enviar información sobre nuevas funcionalidades y actualizaciones</li>
                    <li>Realizar encuestas de satisfacción</li>
                    <li>Enviar comunicaciones de marketing</li>
                    <li>Elaborar estadísticas y estudios de mercado (datos anonimizados)</li>
                </ul>
                ...
                <ul>
                    <li><strong>Proveedores de infraestructura:</strong> Para el alojamiento y operación de la plataforma (servidores en México)</li>
                    <li><strong>Procesadores de pago:</strong> Para gestionar transacciones (certificados PCI-DSS)</li>
                    <li><strong>Proveedores de servicios de IA:</strong> Para funcionalidades de inteligencia artificial (sin retención de datos)</li>
                ...
                <ul>
                    ...
                    <li><strong>Cancelación:</strong> Pedir la eliminación de sus datos</li>
                    <li><strong>Oposición:</strong> Oponerse al tratamiento de sus datos para ciertas finalidades</li>
                </ul>

                <p>Para ejercer sus derechos ARCO, envíe una solicitud a <a href="mailto:privacidad@iurefficient.com">privacidad@iurefficient.com</a> incluyendo:</p>
                <ol>
                ...
                <p>Para más información sobre nuestras prácticas de seguridad, visite nuestra <a href="../seguridad/">página de seguridad</a>.</p>

                <h2 id="cambios">8. Cambios al Aviso de Privacidad</h2>
                <p>Nos reservamos el derecho de modificar este Aviso de Privacidad en cualquier momento. Los cambios serán notificados a través de:</p>
                <ul>
                    <li>Publicación en nuestro sitio web</li>
                    <li>Notificación por correo electrónico (para cambios sustanciales)</li>
                ...
                <ul>
                    <li><strong>Correo electrónico:</strong> <a href="mailto:privacidad@iurefficient.com">privacidad@iurefficient.com</a></li>
                ...
                <p style="margin-top: var(--spacing-3xl); padding-top: var(--spacing-xl); border-top: 1px solid var(--gray-200); font-size: 0.875rem; color: var(--gray-500);">
                    Este Aviso de Privacidad se elabora en cumplimiento de la Ley Federal de Protección de Datos Personales en Posesión de los Particulares (LFPDPPP) publicada en el Diario Oficial de la Federación el 5 de julio de 2010 y su Reglamento.
                </p>
            </div>
        </div>
    </main>

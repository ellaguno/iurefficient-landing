        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-brand">
                    <img src="<?= $base_path ?>images/logo-white.svg" alt="Iurefficient" class="footer-logo">
                ...
                <div class="footer-links">
                    <h4>Empresa</h4>
                    <ul>
                        <li><a href="<?= $base_path ?>#equipo">Equipo</a></li>
                ...
                <div class="footer-links">
                    ...
                    <ul>
                        ...
                        <li><a href="<?= $base_path ?>legal/terminos.php">Términos y Condiciones</a></li>
                        <li><a href="<?= $base_path ?>seguridad/">Seguridad</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="footer-bottom">
                <p>&copy; <?= date('Y') ?> Iurefficient. Todos los derechos reservados.</p>
